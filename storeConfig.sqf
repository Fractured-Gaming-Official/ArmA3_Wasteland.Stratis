...
[
	...
	["APERS Tripwire Mine", "APERSTripMine_Wire_Mag", 700, "RCLO_THROWABLE"],
	["APERS Bounding Mine", "APERSBoundingMine_Range_Mag", 750, "RCLO_THROWABLE"],
	["APERS Mine", "APERSMine_Range_Mag", 600, "RCLO_THROWABLE"],
	["Claymore Charge", "ClaymoreDirectionalMine_Remote_Mag", 400, "RCLO_THROWABLE"],
	["M6 SLAM Mine", "SLAMDirectionalMine_Wire_Mag", 750, "RCLO_THROWABLE"],
	["AT Mine", "ATMine_Range_Mag", 1500, "RCLO_THROWABLE"],
	["Explosive Charge", "DemoCharge_Remote_Mag", 750, "RCLO_THROWABLE"],
	["Explosive Satchel", "SatchelCharge_Remote_Mag", 1500, "RCLO_THROWABLE"],
	["Mine Dispenser", "APERSMineDispenser_Mag", 30000, "RCLO_THROWABLE"],
...
[
	["Suppressor 9mm", "muzzle_snds_L", 50, "item", "RCLO_WEAPONACCESSORY"],
	["Suppressor .45 ACP", "muzzle_snds_acp", 75, "item", "RCLO_WEAPONACCESSORY"],
	["Suppressor 5.56mm", "muzzle_snds_M", 100, "item", "RCLO_WEAPONACCESSORY"],
	["Suppressor 5.56mm (Khaki)", "muzzle_snds_m_khk_F", 100, "item", "noDLC", "RCLO_WEAPONACCESSORY"],
	["Suppressor 5.56mm (Sand)", "muzzle_snds_m_snd_F", 100, "item", "noDLC", "RCLO_WEAPONACCESSORY"],
	["Suppressor 5.8mm", "muzzle_snds_58_blk_F", 100, "item", "RCLO_WEAPONACCESSORY"],
	["Suppressor 5.8mm (G Hex)", "muzzle_snds_58_wdm_F", 100, "item", "RCLO_WEAPONACCESSORY"],
	["Suppressor 6.5mm", "muzzle_snds_H", 100, "item", "RCLO_WEAPONACCESSORY"],
	["Suppressor 6.5mm (Khaki)", "muzzle_snds_H_khk_F", 100, "item", "noDLC", "RCLO_WEAPONACCESSORY"],
	["Suppressor 6.5mm (Sand)", "muzzle_snds_H_snd_F", 100, "item", "noDLC", "RCLO_WEAPONACCESSORY"],
	["Suppressor 6.5mm LMG", "muzzle_snds_H_MG", 125, "item", "RCLO_WEAPONACCESSORY"],

	["Suppressor 6.5mm LMG (Black)", "muzzle_snds_H_MG_blk_F", 125, "item", "RCLO_WEAPONACCESSORY"],
	["Suppressor 6.5mm LMG (Khaki)", "muzzle_snds_H_MG_khk_F", 125, "item", "RCLO_WEAPONACCESSORY"],
	["Suppressor Type 115", "muzzle_snds_65_TI_blk_F", 125, "item", "RCLO_WEAPONACCESSORY"],
	["Suppressor Type 115 (Hex)", "muzzle_snds_65_TI_hex_F", 125, "item", "RCLO_WEAPONACCESSORY"],
	["Suppressor Type 115 (G Hex)", "muzzle_snds_65_TI_ghex_F", 125, "item", "RCLO_WEAPONACCESSORY"],
	["Suppressor 7.62mm", "muzzle_snds_B", 125, "item", "RCLO_WEAPONACCESSORY"],
	["Suppressor 7.62mm (Khaki)", "muzzle_snds_B_khk_F", 125, "item", "RCLO_WEAPONACCESSORY"],
	["Suppressor 7.62mm (Sand)", "muzzle_snds_B_snd_F", 125, "item", "RCLO_WEAPONACCESSORY"],
	["Suppressor .338", "muzzle_snds_338_black", 500, "item", "RCLO_WEAPONACCESSORY"],
	["Suppressor .338 (Green)", "muzzle_snds_338_green", 500, "item", "RCLO_WEAPONACCESSORY"],
	["Suppressor .338 (Sand)", "muzzle_snds_338_sand", 500, "item", "RCLO_WEAPONACCESSORY"],
	["Suppressor 9.3mm", "muzzle_snds_93mmg", 600, "item", "RCLO_WEAPONACCESSORY"],
	["Suppressor 9.3mm (Tan)", "muzzle_snds_93mmg_tan", 600, "item", "RCLO_WEAPONACCESSORY"],

	["Suppressor 6.5mm LMG (Black)", "muzzle_snds_H_MG_blk_F", 125, "item", "noDLC", "RCLO_WEAPONACCESSORY"],
	["Suppressor 6.5mm LMG (Khaki)", "muzzle_snds_H_MG_khk_F", 125, "item", "noDLC", "RCLO_WEAPONACCESSORY"],
	["Suppressor 6.5mm Stealth", "muzzle_snds_65_TI_blk_F", 125, "item", "RCLO_WEAPONACCESSORY"],
	["Suppressor 6.5mm Stealth (Hex)", "muzzle_snds_65_TI_hex_F", 125, "item", "RCLO_WEAPONACCESSORY"],
	["Suppressor 6.5mm Stealth (G Hex)", "muzzle_snds_65_TI_ghex_F", 125, "item", "RCLO_WEAPONACCESSORY"],
	["Suppressor 7.62mm", "muzzle_snds_B", 125, "item", "RCLO_WEAPONACCESSORY"],
	["Suppressor 7.62mm (Khaki)", "muzzle_snds_B_khk_F", 125, "item", "noDLC", "RCLO_WEAPONACCESSORY"],
	["Suppressor 7.62mm (Sand)", "muzzle_snds_B_snd_F", 125, "item", "noDLC", "RCLO_WEAPONACCESSORY"],
	["Suppressor .338", "muzzle_snds_338_black", 150, "item", "RCLO_WEAPONACCESSORY"],
	["Suppressor .338 (Green)", "muzzle_snds_338_green", 150, "item", "RCLO_WEAPONACCESSORY"],
	["Suppressor .338 (Sand)", "muzzle_snds_338_sand", 175, "item", "RCLO_WEAPONACCESSORY"],
	["Suppressor 9.3mm", "muzzle_snds_93mmg", 175, "item", "RCLO_WEAPONACCESSORY"],
	["Suppressor 9.3mm (Tan)", "muzzle_snds_93mmg_tan", 175, "item", "RCLO_WEAPONACCESSORY"],

	["Bipod (NATO)", "bipod_01_F_blk", 100, "item", "noDLC", "RCLO_WEAPONACCESSORY"],
	["Bipod (CSAT)", "bipod_02_F_blk", 100, "item", "noDLC", "RCLO_WEAPONACCESSORY"],
	["Bipod (AAF)", "bipod_03_F_blk", 100, "item", "noDLC", "RCLO_WEAPONACCESSORY"],
	["Bipod (MTP)", "bipod_01_F_mtp", 100, "item", "noDLC", "RCLO_WEAPONACCESSORY"],
	["Bipod (Hex)", "bipod_02_F_hex", 100, "item", "noDLC", "RCLO_WEAPONACCESSORY"],
	["Bipod (Olive)", "bipod_03_F_oli", 100, "item", "noDLC", "RCLO_WEAPONACCESSORY"],
	["Bipod (Sand)", "bipod_01_F_snd", 100, "item", "noDLC", "RCLO_WEAPONACCESSORY"],
	["Bipod (Tan)", "bipod_02_F_tan", 100, "item", "noDLC", "RCLO_WEAPONACCESSORY"],
	["Bipod (Khaki)", "bipod_01_F_khk", 100, "item", "noDLC", "RCLO_WEAPONACCESSORY"],
	...
	["TWS", "optic_tws", 100000, "item", "HIDDEN", "RCLO_OPTIC"], // To hide from store list, add "HIDDEN" after "item", like "item", "HIDDEN"]
	["TWS MG", "optic_tws_mg", 150000, "item", "HIDDEN", "RCLO_OPTIC"],
	["Nightstalker", "optic_Nightstalker", 200000, "item", "HIDDEN", "RCLO_OPTIC"]
];
